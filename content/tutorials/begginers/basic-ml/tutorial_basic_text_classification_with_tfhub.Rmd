...
automatically making it a much more memory efficient alterantive than loading the entire dataset to RAM before passing to Keras.
...
```{r}
model %>% 
  evaluate(imdb[[3]] %>% dataset_batch(512))
```
