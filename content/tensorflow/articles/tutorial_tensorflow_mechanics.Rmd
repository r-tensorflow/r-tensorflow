...
menu:
  main:
    name: "TensorFlow Mechanics 101"
    identifier: "tensorflow-tutorials-mechanics-101"
    parent: "tensorflow-tutorials"
    weight: 30
aliases:
  - /tutorial_tensorflow_mechanics.html
---
...
This tutorial provides and in-depth explanation of the code within the [mnist_fully_connected_feed](examples/mnist_fully_connected_feed.html) example.

Simply source the `minst_fully_connected_feed.R` file to start training:
