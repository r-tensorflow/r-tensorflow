...
menu:
  main:
    name: "MNIST for ML Beginners"
    identifier: "tensorflow-tutorials-mnist-beginner"
    parent: "tensorflow-tutorials"
    weight: 10
aliases:
  - /tutorial_mnist_beginners.html
---
...
This tutorial is an explanation, line by line, of what is happening in the [mnist_softmax.R](https://github.com/rstudio/tensorflow/blob/master/inst/examples/mnist/mnist_softmax.R) code.
...
- Run the entire [mnist_softmax.R](https://github.com/rstudio/tensorflow/blob/master/inst/examples/mnist/mnist_softmax.R) R file either before or after reading through the explanations, and use this tutorial to understand the lines of code that aren't clear to you.
