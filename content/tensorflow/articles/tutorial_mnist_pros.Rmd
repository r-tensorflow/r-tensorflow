...
menu:
  main:
    name: "Deep MNIST for Experts"
    identifier: "tensorflow-tutorials-mnist-expert"
    parent: "tensorflow-tutorials"
    weight: 20
aliases:
  - /tutorial_mnist_pros.html
---
...
[mnist_softmax.R](https://github.com/rstudio/tensorflow/blob/master/inst/examples/mnist/mnist_softmax.R)  code, which is a basic implementation of a TensorFlow model.  The second part shows some ways to improve the accuracy.
