...
| <a href="examples.html"><img class="nav-image illustration" src="../images/resources-examples.png" width=250/></a>  | [**Tutorials**](/tutorials) <br/> Introductory examples of using TensorFlow with R. These examples cover the basics of training models with the keras and tensorflow packages.  |
